...
var _findMenuItems = function _findMenuItems() {
  ...
  console.log("menuItems from lib components TableOfContents TableOfContents.js: ", menuItems);
  return menuItems;
};
/**
...
var TableOfContents = function TableOfContents(_ref) {
  ...
  var getElemsInView = function getElemsInView() {
    var items = (0, _toConsumableArray2.default)(document.querySelectorAll('a[href]')).map(function (elem, index, arr) {
      return {
        elem: elem,
